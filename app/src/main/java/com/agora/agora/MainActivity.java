...
import static com.agora.agora.Constant.*;

public class MainActivity extends AppCompatActivity {

    private static final String LOG_TAG = MainActivity.class.getSimpleName();
    private String appId = "5950f282cad141eaa3e9977d11d0e01e";
    private String channelName = "Demo Channel";
    private String token = "0065950f282cad141eaa3e9977d11d0e01eIABMaf6+8QjFt2RQbe5Wm8CNFNhG6WolyBIcX915Zxmlfdy7rscAAAAAEAAcJkWAzBOhYQEAAQDME6Fh";
    ...
    public void onjoinChannelClicked(View view) {
        mRtcEngine.joinChannel(token, channelName, "Video Call", 0);
        setupLocalVideoFeed();
